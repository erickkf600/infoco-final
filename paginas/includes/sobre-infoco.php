 <section id="sobre-infoco" title="Bem-Vindo a infoco">
  <div class="container">
    <div class="cabecalho">
      <h1 class="titulo" title="Bem-Vindo a infoco">Bem-Vindo a <span>InFoco</span></h1>
...
<section class="container col-xl-10" title="Beneficios da infoco">
  <ul class="itens-infoco">
    <div class="row">
...
<section class="container col-xl-10 video-setor" title="Um pouco sobre a InFoco">
  <div class="row">
    <div class="col-md-5 col-sm-12">
      <iframe class="video" width="100%" height="315" title="Infoco Publicidades" src="https://www.youtube.com/embed/1cj0C0q3M7M?rel=0&controls=0&loop=1&playlist=1cj0C0q3M7M" allow="accelerometer; autoplay; gyroscope"></iframe>
    </div>

    <div class="texto-video col-md-7 col-sm-12">
